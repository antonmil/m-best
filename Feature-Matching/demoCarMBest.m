...
%  on Pascal VOC matching datasetes (car dataset) and their improved
...
MaxInstance = 30; % Number of instance (for Car= 30, for Motorbike = 20)
...
for nOut = 0:MaxOutliers
    for kFs=1:MaxInstance
        ...
        K = conKnlGphKD(KP, KQ, gphs); % Pairwise term
